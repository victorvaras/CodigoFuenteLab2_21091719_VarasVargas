...
chatbot(ID, Nombre, Mensaje, StartFlowId, Flows, ChatBot):-
    ...
    constructor_chatbot(ID, Nombre, Mensaje, StartFlowId, Flows, ChatBot).

%chatbot(0, "Asistente  " , "Bienvenido ¿Qué te gustaría hacer? ", 1, [], CB10).

%option(1,"1 - viajar  ",2,4,["viajar","turistear"],O1), option(2,"2 - Estudiar",4,3,["aprender", "perfecionarme"], O2),flow(1,"flujo",[O1,O2,O1,O2,O2],F2),  chatbot(0, "Asistente  " , "Bienvenido ¿Qué te gustaría hacer? ", 1,[F2], CB10).
...
chatbotAddFlow([ID, Nombre, Mensaje, StartFlowId, Flows], New_Flow, ChatBot_Salida):-
    ...
    constructor_chatbot(ID, Nombre, Mensaje, StartFlowId, Flow_Aux, ChatBot_Salida).


%option(1,"1 - viajar  ",2,4,["viajar","turistear"],O1), option(2,"2 - Estudiar",4,3,["aprender", "perfecionarme"], O2),flow(1,"flujo",[O1,O2,O1,O2,O2],F2),  chatbot(0, "Asistente  " , "Bienvenido ¿Qué te gustaría hacer? ", 1, [], CB10),  chatbotAddFlow(CB10, F2, CB11).
